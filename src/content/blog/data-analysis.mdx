...
<GridSection
  items={[
    { title: "Problems", content: "Hello, everyone! In this post, we’re going to dive into the world of machine learning with Scikit-learn, one of the most popular and powerful libraries for data science in Python. " },
    { title: "Approach", content: "Hello, everyone! In this post, we’re going to dive into the world of machine learning with Scikit-learn, one of the most popular and powerful libraries for data science in Python. " },
    { title: "Feature", content: "Hello, everyone! In this post, we’re going to dive into the world of machine learning with Scikit-learn, one of the most popular and powerful libraries for data science in Python. " },
    { title: "Too Long ; Didn’t Read", content: "Hello, everyone! In this post, we’re going to dive into the world of machine learning with Scikit-learn, one of the most popular and powerful libraries for data science in Python. " },
  ]}
/>
